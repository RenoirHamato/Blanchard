    ...
    (function (e) {
        ...
        function o(e, t) {
            try {
                ...
                if (
                    t &&
                    ('object' === ('undefined' == typeof t ? 'undefined' : _typeof(t)) || 'function' == typeof t)
                ) {
                    var n = t.then;
        ...
        (r.prototype['catch'] = function (e) {
            ...
            (r.resolve = function (e) {
                return e && 'object' === ('undefined' == typeof e ? 'undefined' : _typeof(e)) && e.constructor === r
                    ? e
                    : new r(function (t) {
                          t(e);
                      });
            ...
            h = function (e) {
                ...
                'post' === i.toLowerCase() && ((d = c(r, 'post')), (u = '')),
                    ...
                    (l.onreadystatechange = function () {
                        4 === this.readyState &&
                            (200 === this.status ? o(this.responseText) : s && s(this.responseText));
                    }),
                    l.send(d);
            },
            f = function (e, t) {
        ...
        (f.prototype = {
            ...
            handlerKeyup: function (e) {
                ...
                delete this.result[i.name],
                    this.validateItem({name: i.name, value: i.value, group: [], isKeyupChange: !0}),
                    this.renderErrors();
            },
                        ...
                        return (
                            ...
                            t.promisesRemote.length
                                ? void Promise.all(t.promisesRemote).then(function () {
                                      (t.promisesRemote = []),
                                          t.isValidationSuccess ? t.validationSuccess() : t.validationFailed();
                                  })
                                ...
                                ('checkbox' === n.type &&
                                    ...
                                    n.addEventListener('change', function (t) {
                                        ...
                                        delete e.result[r.name],
                                            e.validateItem({name: r.name, value: r.value, group: []}),
                                            e.renderErrors();
                                    })),
                                'radio' === n.type)
                            ) {
                    ...
                    this.promisesRemote.length
                        ? void Promise.all(this.promisesRemote).then(function (t) {
                              t.forEach(function (t) {
                                  return 'ok' === t
                                      ? void e.renderErrors()
                                      : ('error' === t.type && alert('Server error occured. Please try later.'),
            ...
            lockForm: function () {
                for (
                    var e = this.$form.querySelectorAll('input, textarea, button, select'), t = 0, i = e.length;
                    t < i;
                    ++t
                )
